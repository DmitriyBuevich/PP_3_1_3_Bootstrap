...
public class ServiceBase {
    ...
    private void startDB() {
        User user = new User("user", "Ivan", "Ivanov", 25,"ivan@gmail.com", "user");
        User admin = new User("admin", "Oleg", "Petrov", 20, "oleg@mail.ru", "admin");
        User superAdmin = new User("superadmin", "BigAdmin", "BigBig", 30,"bigadmin@gmail.com", "superadmin");
